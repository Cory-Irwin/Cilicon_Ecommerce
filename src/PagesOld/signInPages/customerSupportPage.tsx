    ...
    <>
      ...
      <div className="mx-auto max-w-screen-xl  my-20 px-4 ">
        <div className="flex justify-between">
          <div className="">
            ...
            <div className=" flex relative mt-5 h-15 flex-row gap-6">
              ...
              <div className="bg-teal-900 p-2 top-3 hover:bg-teal-500 absolute text-white right-2">
        ...
        <div className="grid grid-cols-3  grid-rows-2 gap-4">
          ...
          <div className="row-start-2 text-xl text-gray-600">
            <p>• How to cancel a Clicon Order.</p>
        ...
        <div>
          <div className="mx-auto max-w-screen-xl  my-20 px-4 ">
            <div className="flex justify-center  flex-col  items-center">
              <div className="bg-blue-400 p-2 font-bold text-white text-center  w-35">
                <h1>CONTACT US</h1>
              </div>
                ...
                <div className="flex flex-row gap-6 ">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-row gap-2 relative">
                      <button className="bg-teal-900 mt-2 text-white p-4 w-60 hover:bg-teal-500 text-xl">
                        <div className="flex flex-row gap-6 items-center justify-center text-center">
                          <div><h1 className="font-bold"> CALL NOW</h1></div>
                          <div>
                            <img src={Arrow} alt="" />
                          </div>
                        </div>
              ...
              <div className="bg-white p-6 shadow-lg">
                <div className="flex flex-row gap-4">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-row gap-2 relative">
                      <button className="bg-teal-500 mt-2 text-white p-4 w-60 hover:bg-teal-900 text-xl">
                        <div className="flex flex-row gap-6 items-center justify-center text-center">
                          <div><h1 className="font-bold"> CALL NOW</h1></div>
                          <div>
                            <img src={Arrow} alt="" />
