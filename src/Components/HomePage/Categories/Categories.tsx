...
//The mnenu objects that are components that will show when the menu object is required
...
const Dropdown = () => {
  ...
  return (
    //This is the categories button, when you click on it, it activates the dropdown
    //When you sycle through the list, it shows the sub categories.
    ...
    <div ref={dropdownRef} className="relative">
      ...
      {isOpen && (
        <>
          <div className="absolute text-sm pb-2 pt-4 border-2  top-full z-100 left-0 mt-2
           w-72 text-gray-600 hover:text-black bg-white border-gray-300 shadow-2xl rounded 
            cursor-pointer ">
          ...
          <div className="absolute top-full z-100 border-2  left-75 mt-2 h-110s w-220
            bg-white border-gray-300 shadow-2xl rounded  cursor-pointer ">
            {activeMenu ?? false}
          </div>
        </>
      )}
...
const Categories = () => {
  return (
    <section className="w-full bg-white border-b border-gray-200  max-w-screen-xl mx-auto px-6  items-center">
