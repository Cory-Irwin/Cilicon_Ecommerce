        ...
        <section className="w-full bg-white border-b border-gray-200">
            <div
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 w-full">
                    {/* Categories Section */}
                    <div
                        className="bg-gray-100 px-4 py-2 flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-start rounded-md">
                        <h1 className="text-base sm:text-lg font-semibold">
                            All Categories
                        </h1>
                        <img src={Arrow} alt="caret" className="w-4 h-4"/>
                    </div>
