        ...
        {products.map((product, index) => (
          ...
          >
            ...
            <div className="relative w-full h-auto">
              ...
              {/* Price Tag */}
              <div className="absolute z-20 w-20 border-2 h-20 left-22 -top-36 bg-green-600 rounded-full font-bold text-white flex items-center justify-center  text-xl shadow-lg">
                {product.price}
              </div>
            </div>
          </div>
