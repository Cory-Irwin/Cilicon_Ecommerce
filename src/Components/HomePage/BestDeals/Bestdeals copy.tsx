  ...
  return (
    <> <div className="mx-auto max-w-screen-xl  my-10 px-4 ">
      <section className="w-full bg-white  left-0 z-40 ">
        ...
        <div className="mx-auto lg:flex-row flex-col flex flex-1 w-full h-190  ">
          <div className=" w-full lg:border-l-2 lg:border-b-2 lg:border-t-2 border-2 border-gray-200 ">
            {" "}
          ...
          <div className=" border-gray-200 border-2 w-full flex-1 h-full ">
