...
const FeaturedProductCards = (props: FeaturedProductCardsProps) => {
  return (
    <>
      <div className="border-2 border-gray-200 relative flex-1 min-h-70 lg:min-h-80 gap-2 flex-row ">
        ...
        {/* Title */}
        <div className="p-1 text-sm px-2">
          <p className="line-clamp-3">{props.title}</p>
        </div>

        {/* Prices */}
        <div className="p-1 px-2 absolute bottom-2 flex flex-row gap-2 
        items-center">
