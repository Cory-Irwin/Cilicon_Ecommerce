...
const shopPageMainItem = () => {
    ...
    <div>
      ...
      <div className="flex flex-row relative mt-5 justify-between gap-2">
        <div className="border-2 border-gray-200">
          ...
          <div className="bg-green-900 rounded-4xl h-12 w-12 flex top-4 right-145 absolute items-center justify-center">
 ...
 <div className="border-2 border-gray-200">
        ...
        <div className="border-2 border-gray-200">
          <img src={Imac} alt="" className="w-35 h-auto" />
          <div className="bg-green-900 rounded-4xl h-12 w-12 flex absolute top-4 left-145 items-center justify-center">
