...
const HalfProductCard: React.FC<HalfProductCardProps> = ({
  imageurl,
  name,
  description,
}) => {
  return (
    <div className="flex flex-row   justify-between p-10    shadow-lg rounded-lg h-90">
      ...
      <div className="mt-6 md:mt-0 justify-center object-contain  flex items-center">
        <img
          src={imageurl}
          alt={name}
          className="lg:h-150 h-75 p-2  relative  w-auto left-5  object-contain"
        />
      </div>
    </div>
  );
