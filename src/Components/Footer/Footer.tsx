...
const  Footer = () => {
  return (
    <footer className="bg-gray-900 text-white py-10 ">
                <div className="max-w-screen-xl mx-auto px-4 grid grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <div className="space-y-2">
                            <button className="bg-gray-800 px-4 py-2 rounded flex items-center">Get it now <span className="ml-2">Google Play</span></button>
                            <button className="bg-gray-800 px-4 py-2 rounded flex items-center">Get it now <span className="ml-2">App Store</span></button>
                        </div>
                ...
                <div className="text-center mt-6 text-gray-400">Kinbo eCommerce Template © 2021. Design by Templatecookie</div>
            </footer>
  )
}
